package com.adjudication.pages.dental;
...
public class DentalPage extends BasePage{

	MyLogger log = new MyLogger(DentalPage.class.getName());
	
	public DentalPage(WebDriver driver) {
		super(driver);
	}

	String tablePend="//table[@id='DentalPendQueTable']/thead/tr[2]/th";
	String tableOnhold="//table[@id='DentalOnHoldQueTable']/thead/tr[2]/th";
	String tablePayerReview="//table[@id='DentalPayerReviewClaimsListTable']/thead/tr[2]/th";
	String tableManagReview="//table[@id='DentalManagementReviewQueTable']/thead/tr[2]/th";
	String tableApproved="//table[@id='DentalPartialAdjudicatedQueTable']/thead/tr[2]/th";
	String tableDenied="//table[@id='DentalDeniedQueTable']/thead/tr[2]/th";
	String tablePrebatch="//table[@id='DentalApprovedQueTable']/thead/tr[2]/th";
	String tableBatchToPay="//table[@id='DentalPayementBatchQueTable']/thead/tr[2]/th[2]";
	String tablePaid="//table[@id='DentalPaidQueTable']/thead/tr[2]/th";
	...
	public void clickOnOnManagementReview() throws Exception {
		...
		log.logInfo("Clicked on Management tab.");
	...
	public void clickOnBtachClaimToPayButton() throws Exception{
		...
		log.logInfo("Clicked on BatchCalimToPayBUtton tab.");
	}
