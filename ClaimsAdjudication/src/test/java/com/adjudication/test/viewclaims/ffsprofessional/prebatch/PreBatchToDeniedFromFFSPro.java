...
public class PreBatchToDeniedFromFFSPro extends TestBase{

	MyLogger log = new MyLogger(PreBatchToDeniedFromFFSPro.class.getName());
	...
	public void setUp() {
		try {
			...
			id=idProp.getProperty("PreBatchToDeniedFromFFSPro");
		} catch (Exception e) {
			e.printStackTrace();
