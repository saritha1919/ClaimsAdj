...
public class MoveToSignedOffFromFFSPro extends TestBase {

	MyLogger log = new MyLogger(MoveToSignedOffFromFFSPro.class.getName());
	...
	public void commonSteps() throws Exception {
		...
		batchId=idProp.getProperty("MoveToSignedOffFromFFSPro");
	}
	...
	public void moveToSignedOffFromBatchToPay() throws Exception {
		try {
			...
			commonActions.filterData(elementsProp.getProperty("FFSPRO_SIGNEDOFF_TABLE_ID"),2, batchIdFromApp);
	...
	public void moveToSentForPaymentFromSignedOffFFSPro() throws Exception {
		try {
			...
			commonActions.filterData(elementsProp.getProperty("FFSPRO_SIGNEDOFF_TABLE_ID"),2, batchId);
			...
			commonActions.filterData(elementsProp.getProperty("FFSPRO_SENT_FOR_PAYMENT_TABLE_ID"),2,batchId);
