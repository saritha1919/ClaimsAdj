...
public class PreBatchToDeniedFromDental extends TestBase{

	MyLogger log = new MyLogger(PreBatchToDeniedFromDental.class.getName());
	...
	public void setUp() {
		try {
			...
			id=idProp.getProperty("PreBatchToDeniedFromDental");
		} catch (Exception e) {
			e.printStackTrace();
