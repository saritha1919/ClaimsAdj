...
public class MoveToSignedOffFromCAPPro extends TestBase {

	MyLogger log = new MyLogger(MoveToSignedOffFromCAPPro.class.getName());
	...
	public void commonSteps() throws Exception {
		...
		batchId=idProp.getProperty("MoveToSignedOffFromCAPPro");
	}
	...
	public void moveToSignedOffFromBatchToPay() throws Exception {
		try {
			...
			commonActions.filterData(elementsProp.getProperty("CAPPRO_SIGNEDOFF_TABLE_ID"),2, batchIdFromApp);
	...
	public void moveToSentForPaymentFromSignedOffCAPPro() throws Exception {
		try {
			...
			commonActions.filterData(elementsProp.getProperty("CAPPRO_SIGNEDOFF_TABLE_ID"),2, batchId);
			...
			commonActions.filterData(elementsProp.getProperty("CAPPRO_SENT_FOR_PAYMENT_TABLE_ID"),2,batchId);
