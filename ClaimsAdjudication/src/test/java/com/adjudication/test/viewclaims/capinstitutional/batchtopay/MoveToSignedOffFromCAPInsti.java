...
public class MoveToSignedOffFromCAPInsti extends TestBase {

	MyLogger log = new MyLogger(MoveToSignedOffFromCAPInsti.class.getName());
	...
	public void commonSteps() throws Exception {
		...
		batchId=idProp.getProperty("MoveToSignedOffFromCAPInsti");
	}
	...
	public void moveToSignedOffFromBatchToPay() throws Exception {
		try {
			...
			commonActions.filterData(elementsProp.getProperty("CAPINSTI_SIGNEDOFF_TABLE_ID"),2, batchIdFromApp);
	...
	public void moveToSentForPaymentFromSignedOffCAPInsti() throws Exception {
		try {
			...
			commonActions.filterData(elementsProp.getProperty("CAPINSTI_SIGNEDOFF_TABLE_ID"),2, batchId);
			...
			commonActions.filterData(elementsProp.getProperty("CAPINSTI_SENT_FOR_PAYMENT_TABLE_ID"),2,batchId);
