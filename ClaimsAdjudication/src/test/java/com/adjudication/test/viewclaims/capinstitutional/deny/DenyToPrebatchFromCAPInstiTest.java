package com.adjudication.test.viewclaims.capinstitutional.deny;
...
public class DenyToPrebatchFromCAPInstiTest extends TestBase {

	MyLogger log = new MyLogger(DenyToPrebatchFromCAPInstiTest.class.getName());
	...
	public void setUp() {
		try {
			...
			id=idProp.getProperty("DenyToPrebatchFromCAPInstiTest");
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void commonSteps() throws Exception {
		...
		QMPage.clickOnViewClaims(elementsProp.getProperty("CAPINSTI_DENIED_TABLE_ID"));
