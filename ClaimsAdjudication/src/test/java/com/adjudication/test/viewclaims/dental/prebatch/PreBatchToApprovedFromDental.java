...
public class PreBatchToApprovedFromDental extends TestBase{

	MyLogger log = new MyLogger(PreBatchToApprovedFromDental.class.getName());
	...
	public void setUp() {
		try {
			...
			id=idProp.getProperty("PreBatchToApprovedFromDental");
		} catch (Exception e) {
			e.printStackTrace();
