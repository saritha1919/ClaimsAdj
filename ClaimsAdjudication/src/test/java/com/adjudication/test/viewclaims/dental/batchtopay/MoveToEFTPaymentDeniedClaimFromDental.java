...
public class MoveToEFTPaymentDeniedClaimFromDental extends TestBase {

	MyLogger log = new MyLogger(MoveToEFTPaymentDeniedClaimFromDental.class.getName());
	...
	public void commonSteps() throws Exception {
		...
		batchId=idProp.getProperty("MoveToEFTPaymentDeniedClaimFromDental");
	}
