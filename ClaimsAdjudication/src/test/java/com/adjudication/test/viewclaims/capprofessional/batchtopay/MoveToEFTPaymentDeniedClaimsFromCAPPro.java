...
public class MoveToEFTPaymentDeniedClaimsFromCAPPro extends TestBase {

	MyLogger log = new MyLogger(MoveToEFTPaymentDeniedClaimsFromCAPPro.class.getName());
	...
	public void commonSteps() throws Exception {
		...
		batchId=idProp.getProperty("MoveToEFTPaymentDeniedClaimsFromCAPPro");
	}
