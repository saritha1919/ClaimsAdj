...
public class MoveToEFTPaymentDeniedClaimFromFFSPro extends TestBase {

	MyLogger log = new MyLogger(MoveToEFTPaymentDeniedClaimFromFFSPro.class.getName());
	...
	public void commonSteps() throws Exception {
		...
		batchId=idProp.getProperty("MoveToEFTPaymentDeniedClaimFromFFSPro");
	}

	@Test(priority = 1,groups = { "Regression" })
	public void moveToPaidFromEFTPaymentDeniedClaimsFFSPro() throws Exception {
		try {
			...
			softAssert.assertEquals(batchId, QMPage.getBatchIdFromPaidWithFilter(elementsProp.getProperty("FFSPRO_PAID_TABLE_ID")));
