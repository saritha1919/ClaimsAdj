...
public class PreBatchToApprovedFromFFSInsti extends TestBase{

	MyLogger log = new MyLogger(PreBatchToApprovedFromFFSInsti.class.getName());
	...
	public void setUp() {
		try {
			...
			id=idProp.getProperty("PreBatchToApprovedFromFFSInsti");
		} catch (Exception e) {
			e.printStackTrace();
