...
public class PreBatchToApprovedFromFFSPro extends TestBase{

	MyLogger log = new MyLogger(PreBatchToApprovedFromFFSPro.class.getName());
	...
	public void setUp() {
		try {
			...
			id=idProp.getProperty("PreBatchToApprovedFromFFSPro");
		} catch (Exception e) {
			e.printStackTrace();
