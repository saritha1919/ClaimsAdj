...
public class PreBatchToDeniedFromCAPInsti extends TestBase{

	MyLogger log = new MyLogger(PreBatchToDeniedFromCAPInsti.class.getName());
	...
	public void setUp() {
		try {
			...
			id=idProp.getProperty("PreBatchToDeniedFromCAPInsti");
		} catch (Exception e) {
			e.printStackTrace();
