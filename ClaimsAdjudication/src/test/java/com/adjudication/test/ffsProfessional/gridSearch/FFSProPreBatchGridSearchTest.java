...
public class FFSProPreBatchGridSearchTest extends TestBase {

	MyLogger log = new MyLogger(FFSProPreBatchGridSearchTest.class.getName());
	...
	String tr = "//table[@id='FFSApprovedQueTable']/tbody/tr";
	String td = "FFSApprovedQueTable";
	...
	public void setUp() {
		try {
			...
			sheetName = excelProp.getProperty("FFSPRO_PREBATCH_GRIDSEARCH_ELE");
	...
	@Test
	public void ffsProPreBatchGridSearchTest() {
		try {
	...
	public void loadExcelData(int i) {
		...
		getValueToFilterWithOutCOB = excel.readData(sheetName,
				"GetValueToFilterWithoutCOB", i);
		searchTextBoxXapth = excel.readData(sheetName, "SearchTextBox", i);
		resultInTabelXpath = excel.readData(sheetName, excelProp.getProperty("TBL_RESULT_GRIDSEARCH"), i);
