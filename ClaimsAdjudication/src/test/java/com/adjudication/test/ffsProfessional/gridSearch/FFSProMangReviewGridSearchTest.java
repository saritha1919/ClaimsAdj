...
public class FFSProMangReviewGridSearchTest extends TestBase {

	MyLogger log = new MyLogger(FFSProMangReviewGridSearchTest.class.getName());

	LinkedHashMap<String, String> filterData;
	String sortingXapth;
	String sheetName="FFSPRO_MANGREVIEW_GRIDSEARCH_ELE";
	String fieldName;
	...
	String tr = "//table[@id='FFSManagementReviewQueTable']/tbody/tr";
	String td = "FFSManagementReviewQueTable";
	...
	@Test
	public void ffsProMangReviewGridSearchTest() {
		try {
			...
			ffsProPage.clickOnOnManagementReview();
